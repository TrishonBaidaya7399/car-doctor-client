            ...
            <div className="bg-gray-200 rounded-lg p-12 mx-[20px] md:mx-[50px] lg:mx-[100px] my-[20px] md:my-[50px] lg:my-[100px]">
                <form onSubmit={handleCheckOut}>
                    <div className="flex flex-col md:flex-row gap-6 mb-6">
                       <input type="text" name="firstname" defaultValue={defaultFirstName} placeholder="First Name" className="bg-white rounded-lg p-4 w-full" />
                       <input type="text" name="lastname" defaultValue={defaultLastName} placeholder="Last Name" className="bg-white rounded-lg p-4 w-full" />
                    </div>
                    <div className="flex flex-col md:flex-row gap-6 mb-6">
                       <input type="text" maxLength="11" name="phone" placeholder="Your Phone" className="bg-white rounded-lg p-4 w-full" />
                       <input type="email" name="email" placeholder="Your Email" defaultValue={user?.email} className="bg-white rounded-lg p-4 w-full" />
                    </div>
                    <div className=" gap-6 mb-6">
                       <textarea type="text" name="message" placeholder="Your Message" className="bg-white rounded-lg p-4 w-full h-40" />
                    </div>
                    <div className=" gap-6">
